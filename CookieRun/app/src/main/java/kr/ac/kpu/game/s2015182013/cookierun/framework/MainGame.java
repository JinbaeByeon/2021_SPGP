...
public class MainGame {
    ...
    // singleton
    private static kr.ac.kpu.game.s2015182013.cookierun.framework.MainGame instance;
    private Player player;
    private Score score;

    public static kr.ac.kpu.game.s2015182013.cookierun.framework.MainGame get() {
        if (instance == null) {
            instance = new kr.ac.kpu.game.s2015182013.cookierun.framework.MainGame();
        }
        return instance;
    }
